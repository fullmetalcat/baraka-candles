...
class StockTest {
    ...
    void should_return_return_single_unfinished_candle() {
        ...
        // then
        assertThat(result).isEqualTo(List.of(new Candle(candleSize, time, price1, price2, price1, price2)));
    }
    ...
    void should_return_return_finished_and_unfinished_candle() {
        ...
        assertThat(result).isEqualTo(List.of(
            ...
            new Candle(candleSize, timeNotFinished, price2, price2, price2, price2)
        ));
    }
    ...
    void should_support_complex_intervals_and_return_candles() {
        ...
        assertThat(result).isEqualTo(List.of(
            ...
            new Candle(candleSize, timeNotFinished, price1, price1, price1, price1)
        ));
    }
}